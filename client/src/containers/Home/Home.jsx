...
const Home = () => {
  return (
    <div>
      ...
      <div className="divider"></div>
      <h2 style={{ textAlign: "center", fontFamily: "Monoton" }}>
        TO GET STARTED
      </h2>
      <p
        style={{ fontFamily: "Roboto", fontSize: "20px", textAlign: "center" }}
      >
        Create an account to start tracking subscriptions. Already have an
